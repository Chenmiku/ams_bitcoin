...
// 	switch coinType {
// 	case "btc":
// 		result = new(big.Float).Quo(fbalance, big.NewFloat(math.Pow10(8))) //(float64(value) /100000000)
// 	case "eth":
// 		result = new(big.Float).Quo(fbalance, big.NewFloat(math.Pow10(18))) //(float64(value) /1000000000000000000)
// 	case "":
// 		result = new(big.Float).Quo(fbalance, big.NewFloat(math.Pow10(8))) //(float64(value) /100000000)
// 	}
