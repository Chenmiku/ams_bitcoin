...
exports.create_a_transaction = async(req, res) => {
  ...
  var service = q.service;
  var trans = new Trans()
  var feeValue = 1000000000 * 200000  //2000000000 * 21000
  ...
  switch(coinType) {
    ...
    case 'eth':
      ...
      console.log(contractInstance.methods.balanceOf(sender))
      ...
      var rawTransaction = {
        ...
        to: contractAddress,
        value: w3.utils.toHex(0), //senderBalance - feeValue
        data: contractInstance.methods.transfer(receiver, w3.utils.toHex(100)).encodeABI()
      }
